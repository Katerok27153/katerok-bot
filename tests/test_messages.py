import main2 as main_module

def test_build_messages_includes_character_and_rules(db_module, monkeypatch):
    db = db_module
    main = main_module
...
def test_build_messages_uses_default_character_when_not_set(db_module):
    db = db_module
    main = main_module
...
def test_build_messages_for_character_pure_function():
    main = main_module
